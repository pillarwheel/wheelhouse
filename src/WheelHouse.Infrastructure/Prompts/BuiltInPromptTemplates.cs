...
/// <summary>
/// The Gemini R&amp;D prompt templates shipped with WheelHouse. Seeded into the database on
/// first run; users can add their own alongside these.
/// </summary>
public static class BuiltInPromptTemplates
{
    public static IReadOnlyList<PromptTemplate> All { get; } = new[]
    {
        new PromptTemplate
        {
            Name = "Technical Feasibility & System Integration Research Plan",
            Category = "Research",
            IsBuiltIn = true,
            Description = "Research and compile a plan for bridging two separate components, APIs, or layers " +
                          "(e.g., backend logic and frontend visualization, or importing physical geometries/graphs).",
            Body =
                """
        ...
        new PromptTemplate
        {
            Name = "Feature Upgrade, UI, & Backend Enhancements Plan",
            Category = "Feature",
            IsBuiltIn = true,
            Description = "Plan visual enhancements alongside endpoint/logic upgrades, conflict resolution rules, " +
                          "throttling, and data feedback loops.",
            Body =
                """
                SYSTEM / ROLE PROMPT — {{ROLE_TITLE}}
        ...
        new PromptTemplate
        {
            Name = "Conversation Absorption & Refinement Status Report",
            Category = "Aggregation",
            IsBuiltIn = true,
            Description = "Feed a long conversation transcript, task checklist, or run logs into Gemini to " +
                          "compile a unified implementation status report and handoff plan.",
            Body =
                """
        ...
        new PromptTemplate
        {
            Name = "Diagnostic, Debugging & Bug Resolution Plan",
            Category = "Debugging",
            IsBuiltIn = true,
            Description = "Research a failing test, compilation error, or unexpected bug, diagnosing the root " +
                          "cause and producing an execution plan to resolve it.",
            Body =
                """
        ...
        new PromptTemplate
        {
            Name = "Database Schema Design & Migration Plan",
            Category = "Database",
            IsBuiltIn = true,
            Description = "Plan database table modifications, schema updates, entity mapping (e.g., EF Core, " +
                          "Dapper), and migration scripts while ensuring zero data loss.",
            Body =
                """
        ...
        new PromptTemplate
        {
            Name = "API Integration & Third-Party SDK Research Plan",
            Category = "Integration",
            IsBuiltIn = true,
            Description = "Research and plan the integration of an external API, third-party library, or SDK " +
                          "(e.g., adding a local model provider or external REST client).",
            Body =
                """
